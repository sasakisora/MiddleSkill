		...
		for(int i = 2; i < strArray1.size(); i++) {
			...
			for(int n=0; n<strArray2.size(); n++) {
				...
				for(int t=0;t<strArray3.size(); t++) {
					if(strArray3.get(t).equals ("k") && strArray4.size()==0 || strArray3.get(t).equals ("a") && strArray4.size()==1 || strArray3.get(t).equals ("k") && strArray4.size()==2|| strArray3.get(t).equals ("a") && strArray4.size()==3 || strArray3.get(t).equals ("o") && strArray4.size()==4) {
